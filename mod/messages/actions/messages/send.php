...
$body = get_input('body');
$recipient_guid = get_input('as_values_rcpt');
$recipient_guid1 = get_input('as_values_rcpt');
...
$arrUser = explode(",",$recipient_guid);
foreach ($arrUser as $recipient_guid){
	if (!is_numeric($recipient_guid)) continue;
