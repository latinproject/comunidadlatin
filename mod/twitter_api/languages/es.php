...
$spanish = array(
	'twitter_api' => 'Servicios Twitter',

	'twitter_api:requires_oauth' => 'Los servicios de Twitter requieren requieren que el plugin OAuth Libraries esté activado.',

	'twitter_api:consumer_key' => 'Consumer Key',
	'twitter_api:consumer_secret' => 'Consumer Secret',

	'twitter_api:settings:instructions' => 'Usted debe obtener el consumer key y secret de la siguiente dirección <a href="https://dev.twitter.com/apps/new" target="_blank">Twitter</a>. Llene el formulario para crear nueva aplicación. Seleccione "Navegador (Browser)" como tipo de aplicación y "Read & Write" para el tipo de acceso. The callback url is %stwitter_api/authorize',
