...
if(array_key_exists('recaptcha_verified', $_SESSION) && $_SESSION['recaptcha_verified'] == 1) {
   ...
   $output = "<label class='label_captcha'>".elgg_echo('recaptcha:label:human_verification')."</label><b>".elgg_echo('recaptcha:verified')."</b><br><br>";
}
else {
    if($plugin_settings['require_recaptcha'] == 'on') {
        ...
        $output = "<label class='label_captcha'>".elgg_echo('recaptcha:label:human_verification')."</label><br>";
