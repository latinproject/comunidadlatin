<?php 
	...
	*/
	...
	function profile_manager_init(){
		...
		elgg_register_page_handler("template", "profile_manager_page_handler");
		elgg_register_page_handler("template_pt", "profile_manager_page_handler");
		/* AO, Agosto 2 fancy popup */
		elgg_register_page_handler("contestinfo", "profile_manager_page_handler");
		elgg_register_page_handler("contestinfo-pt", "profile_manager_page_handler");
	...
	function profile_manager_page_handler($page){
		switch($page[0]){
			...
			case "contestrules-pt":
                ...
                return true;
                        case "template":
                include(dirname(__FILE__) . "/pages/template_postulacion.php");
                return true;
                        case "template_pt":
                include(dirname(__FILE__) . "/pages/template_postulacion_pt.php");
                return true;
		/* AO, Agosto 2 fancy popup */
			case "contestinfo":
		include(dirname(__FILE__) . "/pages/contestinfo.php");
		return true;
			case "contestinfo-pt":
		include(dirname(__FILE__) . "/pages/contestinfo-pt.php");
		return true;
