...
$content .= "<label class='institution' style='$labelStyle float:left; font-size: 13px;' > " . elgg_echo("published:by", array($ownerLink)) . " </label><br /><br />";
...
$content .= "<label class='institution' style='$labelStyle margin-top: 2px;' > \"" . trim($description) . "\"</label><br /><br />";
