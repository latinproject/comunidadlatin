...
$content .= "<div class='group-found-div' style='margin-top: -2px; margin-bottom: -2px; overflow-x: hidden;'>";
...
$content .= "<label class='institution' style='$labelStyle float:left; font-size: 13px;' >  " . elgg_echo ("by", array($ownerLink)) . " </label>";
