...
$labelStyle = "margin-top: 3px; white-space: nowrap; max-width: 86%; overflow-x: hidden;";
...
$ownerLink = elgg_view('output/url', array(
    ...
    'is_trusted' => true,));
$content .= "<label class='institution' style='$labelStyle float:left; font-size: 13px;' > " . elgg_echo("file:uploaded:by", array($ownerLink)) .  "</label><br /><br />";



$title1 = $time;
$file1 = elgg_get_site_url() . '_graphics/clock.png';
$icon1 = "<img src='$file1' style='$iconStyle float:left; margin-right: 10px;'>";

$labelStyle = "margin-top: 0px; white-space: nowrap; float: left; font-family: Lucida Grande, Helvetica, Arial, sans-serif; font-size: 13px; font-style: normal; font-variant: normal; font-weight: normal; margin-top: 3px;";
