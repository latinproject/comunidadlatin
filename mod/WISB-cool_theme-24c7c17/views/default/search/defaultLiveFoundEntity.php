...
$file = $entity->getIconURL();
$icon = "<img src='$file'>";
$theUrl = $entity->getURL();

$name = $entity->getVolatileData('search_matched_title');

$institution = $entity->Institution;
$city = $entity->City;
$country = $entity->Country;
$tags = $entity->interests;

$matchedDescription = $entity->getVolatileData('search_matched_description');
...
$writingGroups = getWritingGroups($entity);
$totalWritingGroups = count($writingGroups);

$members = getMembers($entity);
