...
echo '<p>'; 
echo elgg_view('input/hidden', array('name' => 'params[phpmailer_override]', 'js' => 'id="params[phpmailer_override]"', 'value' => $phpmailer_override )); 
...
// SMTP Settings
echo '<p>'; 
echo elgg_view('input/hidden', array('name' => 'params[phpmailer_smtp]', 'js' => 'id="params[phpmailer_smtp]"', 'value' => $phpmailer_smtp )); 
...
echo '<br /><br />';
echo elgg_view('input/hidden', array('name' => 'params[phpmailer_smtp_auth]', 'js' => 'id="params[phpmailer_smtp_auth]"', 'value' => $phpmailer_smtp_auth )); 
...
echo '<p>';
echo elgg_view('input/hidden', array('name' => 'params[ep_phpmailer_ssl]', 'js' => 'id="params[ep_phpmailer_ssl]"', 'value' => $ep_phpmailer_ssl ));
...
echo elgg_view('input/hidden', array('name' => 'params[nonstd_mta]', 'js' => 'id="params[nonstd_mta]"', 'value' => $nonstd_mta )); 
